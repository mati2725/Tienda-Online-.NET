<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadisticasCategorias.aspx.cs" Inherits="Tp_Integrador___Grupo3.Gestion.ReportesVentas" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <h1 style="text-align: center; background-color: #00CC99; height: 35px; font-size: xx-large; color: #000000;" class="auto-style1">ESTADÍSTICAS DE CATEGORÍAS</h1>
            Buscar categoria:
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                <Columns>
                    <asp:TemplateField HeaderText="Categoria">
                        <ItemTemplate>
                            <asp:Label ID="lblNombreCategoria" runat="server" Text='<%# Eval("Categoria") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
